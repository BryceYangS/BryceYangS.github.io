...
<table style="border:0;">
    <tr>
        <td><img src="https://image.aladin.co.kr/product/139/35/cover500/0764543857_1.jpg"></td>
        <td>
            <ul style="line-height: 3.5em;">
                <li>2002년 로드 존슨의 <b>"J2EE Design and Development"</b> 책으로부터 시작</li>
                <li>책 출간 이후 Jurgen Hoeller(유겐 휠러), Yann Caroff(얀 카로프)</li>
